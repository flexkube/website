...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.2d97473a4d2ee67aafacbeba864d5f99b7a1371cd8a7ba22c29c6a59086f236f.js',function(){input.required=false;search();});}
